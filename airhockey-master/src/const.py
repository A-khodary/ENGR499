...
PLAYER1_START = (BORDER_LEFT+FIELD_WIDTH*0.2,BORDER_TOP+FIELD_HEIGHT*0.5)
...
MALLET_MASS=4.5
FAN_FORCE=1
MALLET_ACCELERATION=(FAN_FORCE/MALLET_MASS)/1000
...
goal_x = BORDER_LEFT+FIELD_WIDTH*0.5
	
goal_y = BORDER_TOP+FIELD_HEIGHT*0.5
