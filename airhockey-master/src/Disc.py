...
class Disc(ActiveCircle.ActiveCircle):

    def __init__( self, pos, angle, magnitude, mass, path, max_speed, friction):
        ActiveCircle.ActiveCircle.__init__( self, pos, angle, magnitude, mass, path, max_speed)
